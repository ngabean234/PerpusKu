...
abstract class MHAppTextStyles {
  ...
  TextStyle textStyle15({Color? color}) => GoogleFonts.outfit(
      fontSize: 12.0, fontWeight: FontWeight.w700, color: color);
  TextStyle textStyle16({Color? color}) => GoogleFonts.outfit(
      fontSize: 10.0, fontWeight: FontWeight.w400, color: color);
  TextStyle textStyle17({Color? color}) => GoogleFonts.outfit(
      fontSize: 14.0, fontWeight: FontWeight.w700, color: color);
  TextStyle textStyle18({Color? color}) => GoogleFonts.outfit(
  ...
  TextStyle textStyle6({Color? color}) => GoogleFonts.inter(
      fontSize: 10.0, fontWeight: FontWeight.w300, color: color);
  TextStyle textStyle7({Color? color}) => TextStyle(
      fontSize: 15.0,
      fontWeight: FontWeight.w400,
      fontFamily: "JostRoman-Regular",
      color: color);
  TextStyle textStyle8({Color? color}) => GoogleFonts.inter(
